...
from ..models import User, Subscriptions, db
import time
import eventlet
...
@socketio.on('record_ids', namespace='/')
...
def listen_thread():
    ...
    pubsub.listen('items_table_update')
    while True:
